(() => {
  ...
  const fallbackWorldTargets = [
    ...
    { id: "convivium", label: "MonoConvivium", href: "mono-convivium/", object: "apron" },
  ...
  const fallbackChapterSequence = [
    ...
    { id: "convivium", label: "MonoConvivium", href: "mono-convivium/", temperature: "human", regia: "silenziosa", gesture: "filo" },
