...
- Versione cache-busting: `https://monobottega.it/?v=20260712-opening-app-v1`
- Versione favicon: `20260712-plate-icon-v1`
...
- Aggiornato cache-busting a `20260712-opening-app-v1`.
- Aggiornato service worker a `mono-site-v37`.
- Aggiornata favicon browser con icona MONO piatto e posate.
...
- `service-worker.js` - cache `mono-site-v37`.
...
2. Verificare live da telefono e PC:
   `https://monobottega.it/?v=20260712-opening-app-v1`
