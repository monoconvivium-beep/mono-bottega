...
- Versione cache-busting: `https://monobottega.it/?v=20260711-palette-v1`
...
- Aggiornato cache-busting a `20260711-palette-v1`.
- Aggiornato service worker a `mono-site-v23`.
...
- `service-worker.js` - cache `mono-site-v23`.
...
2. Verificare live da telefono e PC:
   `https://monobottega.it/?v=20260711-palette-v1`
